...
namespace Plugin.Sync.Commerce.CatalogImport.Pipelines.Blocks
{
    ...
    /// </summary>
    [PipelineDisplayName("SetSellableItemComposerFields")]
    public class SetSellableItemComposerFields : PipelineBlock<ImportSellableItemArgument, ImportSellableItemResponse, CommercePipelineExecutionContext>
    {
        ...
        public SetSellableItemComposerFields(CommerceCommander commerceCommander, ComposerCommander composerCommander)
        {
        ...
        {
            arg.SellableItem = await _importHelper.ImportComposerViewsFields(arg.SellableItem, arg.EntityData, context.CommerceContext) as SellableItem;
