...
namespace Plugin.Sync.Commerce.CatalogImport.Extensions
{
    ...
    {
        public static void AddListPrice(this SellableItemResponse sellableItem, decimal sellableItemListPrice)
        {
        ...
        public static void AddVariantListPrice(this SellableItemResponse sellableItem, decimal sellableItemListPrice, ItemVariationComponent variant)
        {
            if (sellableItemListPrice == 0)
            {
                return;
